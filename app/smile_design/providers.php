...
if (!function_exists('smile_design_lip_repositioning_surgical_prompt')) {
    function smile_design_lip_repositioning_surgical_prompt(array $context): string
    {
        ...
        return implode(' ', array_values(array_filter([
            ...
            'The upper lip unrolls downward, making it appear 7 to 9 mm taller (longer vertically) in the smile. This is a HEIGHT/POSITION change only — the same amount of lip tissue now covers more vertical distance because the curl is fully unrolled. Do not be conservative: the full surgical correction must be visible.',
