...
if (!function_exists('codex_security_action_scopes')) {
    function codex_security_action_scopes(string $action, array $body): array
    {
        $map = [
            ...
            'crm_operator_brief' => ['leads:read'],
            'crm_operator_command_center' => ['leads:read'],
            'lead_queue_summary' => ['leads:read'],
            'list_leads' => ['leads:read'],
            'lead_queue' => ['leads:read'],
            'nurture_candidates' => ['leads:read'],
            'sms_delivery_issues' => ['leads:read'],
            'conversation_quality' => ['leads:read'],
            'meta_lead_ad_correlation' => ['leads:read'],
            'api_self_check' => ['system:read'],
            'inbox' => ['leads:read'],
            'get_lead' => ['leads:read'],
            ...
            'mobile_push_status' => ['system:read'],
            'mobile_push_test' => ['messages:send'],
        ];
