...
if (!function_exists('smile_design_lip_repositioning_surgical_prompt')) {
    function smile_design_lip_repositioning_surgical_prompt(array $context): string
    {
        ...
        return implode(' ', array_values(array_filter([
            ...
            'Allowed edit region: only the upper-lip lower border, the upper-lip roll/vermilion posture, and the visible gum band directly above the maxillary upper teeth.',
            ...
            'The bottom edge of the upper lip must follow the natural smile curvature and land at the cervical contour / gingival-zenith line of the visible upper incisors and canines. For 45-degree angles, apply the same drape along the visible tooth arch.',
            ...
            'Do not change global exposure, white balance, color temperature, contrast, or shadows; teeth and skin must keep the same source-photo tone.',
            'Preserve the lower lip, mouth corners, cheeks, chin, jawline, nose, eyes, eyebrows, skin texture, skin tone, hair, neck, clothing, background, age, identity, and overall expression.',
            'Do not make the patient look younger, slimmer, more glamorous, airbrushed, or like a different person.',
            'Do not create filler lips, lipstick, swelling, surgical marks, scars, sutures, labels, arrows, text, borders, split screens, or watermarks.',
            ...
            'Before finalizing, compare the before and after: the visible gum band must be smaller because the upper lip is actually lower and more naturally draped. The final output must look like the same real photograph with only a surgical upper-lip-line repositioning preview applied.',
