...
$crmNavItems = [
    ...
    ['key' => 'dentrix_schedule', 'label' => 'Dentrix Schedule', 'href' => base_url('dentrix-schedule'), 'icon' => 'M4 5h16v15H4zM4 9h16M8 3v4M16 3v4', 'show' => function_exists('auth_has_role') ? auth_has_role('admin', 'marketing_manager', 'staff') : false],
