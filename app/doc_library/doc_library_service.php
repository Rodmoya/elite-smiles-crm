                ...
                'sections' => [
                    ...
                    [
                        ...
                        'rows' => [
                            ...
                            [['type' => 'text', 'label' => 'Social Security #', 'name' => 'welcome_ssn'], ['type' => 'date', 'label' => 'Birthdate', 'name' => 'welcome_birthdate'], ['type' => 'text', 'label' => 'Age', 'name' => 'welcome_age', 'size' => 'short']],
                            ...
                            [['type' => 'text', 'label' => 'Day Phone', 'name' => 'welcome_day_phone'], ['type' => 'text', 'label' => 'Alt Phone', 'name' => 'welcome_alt_phone'], ['type' => 'email', 'label' => 'E-mail', 'name' => 'welcome_email']],
                            ...
                            [['type' => 'text', 'label' => 'Employer/School', 'name' => 'welcome_employer_school'], ['type' => 'text', 'label' => 'Occupation', 'name' => 'welcome_occupation']],
                            [['type' => 'text', 'label' => 'Employer/School Address', 'name' => 'welcome_employer_school_address', 'size' => 'wide'], ['type' => 'text', 'label' => 'Employer/School Phone', 'name' => 'welcome_employer_school_phone']],
                    ...
                    [
                        ...
                        'rows' => [
                            [['type' => 'text', 'label' => 'In case of emergency, notify', 'name' => 'welcome_emergency_name', 'size' => 'wide'], ['type' => 'text', 'label' => 'Phone', 'name' => 'welcome_emergency_phone']],
                        ],
                    ],
                    [
                        ...
                        'rows' => [
                            [['type' => 'text', 'label' => 'Last Name', 'name' => 'welcome_responsible_last_name'], ['type' => 'text', 'label' => 'First Name', 'name' => 'welcome_responsible_first_name'], ['type' => 'text', 'label' => 'Relationship to Patient', 'name' => 'welcome_responsible_relationship']],
                            [['type' => 'text', 'label' => 'Social Security #', 'name' => 'welcome_responsible_ssn'], ['type' => 'text', 'label' => 'Phone', 'name' => 'welcome_responsible_phone']],
                            ...
                            [['type' => 'text', 'label' => 'Occupation', 'name' => 'welcome_responsible_occupation'], ['type' => 'text', 'label' => 'Employed by', 'name' => 'welcome_responsible_employed_by']],
                            [['type' => 'text', 'label' => 'Business Address', 'name' => 'welcome_responsible_business_address', 'size' => 'wide'], ['type' => 'text', 'label' => 'Business Phone', 'name' => 'welcome_responsible_business_phone']],
                        ],
                    ],
                    [
                        ...
                        'rows' => [
                            ...
                            [['type' => 'text', 'label' => 'Insurance Company', 'name' => 'welcome_primary_insurance_company'], ['type' => 'text', 'label' => 'ID/Contract #', 'name' => 'welcome_primary_id'], ['type' => 'text', 'label' => 'Group #', 'name' => 'welcome_primary_group']],
                            [['type' => 'text', 'label' => 'Subscriber Name', 'name' => 'welcome_primary_subscriber_name'], ['type' => 'date', 'label' => 'Subscriber Birthdate', 'name' => 'welcome_primary_subscriber_birthdate'], ['type' => 'text', 'label' => 'Relationship to Patient', 'name' => 'welcome_primary_subscriber_relationship']],
                            [['type' => 'text', 'label' => 'Subscriber Address', 'name' => 'welcome_primary_subscriber_address', 'class' => 'doc-field-full']],
                            [['type' => 'text', 'label' => 'Subscriber City/State/Zip', 'name' => 'welcome_primary_subscriber_city_state_zip', 'size' => 'wide'], ['type' => 'text', 'label' => 'Subscriber Phone', 'name' => 'welcome_primary_subscriber_phone']],
                            [['type' => 'text', 'label' => 'Subscriber employed by business', 'name' => 'welcome_primary_subscriber_employed_by'], ['type' => 'text', 'label' => 'Additional Dependents on Plan', 'name' => 'welcome_primary_dependents']],
                            ...
                            [['type' => 'text', 'label' => 'Insurance Company', 'name' => 'welcome_additional_insurance_company'], ['type' => 'text', 'label' => 'Subscriber Name', 'name' => 'welcome_additional_subscriber_name']],
                            [['type' => 'date', 'label' => 'Birthdate', 'name' => 'welcome_additional_subscriber_birthdate'], ['type' => 'text', 'label' => 'Relationship to Patient', 'name' => 'welcome_additional_subscriber_relationship'], ['type' => 'text', 'label' => 'Subscriber Phone', 'name' => 'welcome_additional_subscriber_phone']],
                            [['type' => 'text', 'label' => 'Subscriber Address', 'name' => 'welcome_additional_subscriber_address', 'class' => 'doc-field-full']],
                            [['type' => 'text', 'label' => 'Subscriber City/State/Zip', 'name' => 'welcome_additional_subscriber_city_state_zip'], ['type' => 'text', 'label' => 'Employed by', 'name' => 'welcome_additional_subscriber_employed_by'], ['type' => 'text', 'label' => 'Business Phone', 'name' => 'welcome_additional_subscriber_business_phone']],
                        ],
                    ],
                    [
                        'type' => 'section',
            ...
            [
                ...
                'sections' => [
                    [
                        ...
                        'subtitle' => '(Dental Treatment Consent Form)',
                        'fields' => [
                            ['type' => 'paragraph', 'text' => 'I authorize Dr. Walter Meden and designated associates or assistants to perform such procedures as may be necessary or advisable for the treatment of my dental health or the dental health of my minor child.'],
