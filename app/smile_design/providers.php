...
final class GoogleGeminiSmileDesignImageProvider implements SmileDesignImageProvider
{
    public function createPreview(array $case, array $photos, array $options = []): array
    {
        ...
        $promptParts = [
            ...
            ($isVeneerSimulation ? 'Incisal length ceiling: regardless of LVI style or any length-adjustment slider, do not extend visible tooth length beyond what still sits naturally under the patient\'s own resting upper-lip line from the source photo. An exaggerated, unnaturally long, or denture-like smile line is a failure even when the selected style calls for elongation.' : ''),
