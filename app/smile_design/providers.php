...
if (!function_exists('smile_design_lip_repositioning_surgical_prompt')) {
    function smile_design_lip_repositioning_surgical_prompt(array $context): string
    {
        ...
        return implode(' ', array_values(array_filter([
            ...
            'The lower border of the UPPER lip must descend to the cervical line / gingival-zenith level of the upper teeth — the point where the gum meets the tooth tops — so the exposed gum band is covered.',
            'The bottom edge of the upper lip must follow the natural smile curvature and land at the cervical contour of the upper incisors and canines. For 45-degree angles, apply the same drape along the visible tooth arch.',
            'The upper lip should look less curled upward and less retracted — the previously tightly curled vermilion rolls unfolding downward makes the upper lip appear about 5 to 6 mm taller (longer vertically) in the smile. This is a HEIGHT change, not a volume change. The upper lip is the same thickness/volume — it just covers more vertical distance because it is no longer curled up.',
